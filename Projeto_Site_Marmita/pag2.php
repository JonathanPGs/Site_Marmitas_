...
<body>
  ...
  <h1> LEGUMES COM PEIXE </h1>
  <article class="flex">
    <table>
      <tr>
        <img src="Marmita/Grande2.2.jpg" alt="" class="config">
      ...
      <tr>
        <td><?php echo $LegumesPeixe[0]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesPeixe[1]["TAM-P"]; ?></td>
        <td><?php echo $LegumesPeixe[1]["TAM-M"]; ?></td>
        <td><?php echo $LegumesPeixe[1]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesPeixe[1]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesPeixe[1]["TAM-P"]; ?></td>
        <td><?php echo $LegumesPeixe[1]["TAM-M"]; ?></td>
        <td><?php echo $LegumesPeixe[1]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesPeixe[2]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesPeixe[2]["TAM-P"]; ?></td>
        <td><?php echo $LegumesPeixe[2]["TAM-M"]; ?></td>
        <td><?php echo $LegumesPeixe[2]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesPeixe[3]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesPeixe[3]["TAM-P"]; ?></td>
        <td><?php echo $LegumesPeixe[3]["TAM-M"]; ?></td>
        <td><?php echo $LegumesPeixe[3]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesPeixe[4]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesPeixe[4]["TAM-P"]; ?></td>
        <td><?php echo $LegumesPeixe[4]["TAM-M"]; ?></td>
        <td><?php echo $LegumesPeixe[4]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesPeixe[5]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesPeixe[5]["TAM-P"]; ?></td>
        <td><?php echo $LegumesPeixe[5]["TAM-M"]; ?></td>
        <td><?php echo $LegumesPeixe[5]["TAM-G"]; ?></td>
      </tr>
      </tr>
    </table>
    <br>
