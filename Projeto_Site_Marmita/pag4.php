...
<body>
  ...
  <article class="flex">
    <table>
      ...
      <tr>
        <td><?php echo $Panqueca[1]["IGREDIENTE"]; ?></td>
        <td><?php echo $Panqueca[1]["TAM-P"]; ?></td>
        <td><?php echo $Panqueca[1]["TAM-M"]; ?></td>
        <td><?php echo $Panqueca[1]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $Panqueca[2]["IGREDIENTE"]; ?></td>
        <td><?php echo $Panqueca[2]["TAM-P"]; ?></td>
        <td><?php echo $Panqueca[2]["TAM-M"]; ?></td>
        <td><?php echo $Panqueca[2]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $Panqueca[3]["IGREDIENTE"]; ?></td>
        <td><?php echo $Panqueca[3]["TAM-P"]; ?></td>
        <td><?php echo $Panqueca[3]["TAM-M"]; ?></td>
        <td><?php echo $Panqueca[3]["TAM-G"]; ?></td>
      </tr>
