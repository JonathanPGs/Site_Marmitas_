...
<body>
  ...
  <h1> LEGUMES COM CARNE </h1>
  <article class="flex">
    <table>
      <tr>
        <img src="Marmita/Grande3.jpg" alt="" class="config">
      ...
      <tr>
        <td><?php echo $LegumesCarne[0]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesCarne[1]["TAM-P"]; ?></td>
        <td><?php echo $LegumesCarne[1]["TAM-M"]; ?></td>
        <td><?php echo $LegumesCarne[1]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesCarne[1]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesCarne[1]["TAM-P"]; ?></td>
        <td><?php echo $LegumesCarne[1]["TAM-M"]; ?></td>
        <td><?php echo $LegumesCarne[1]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesCarne[2]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesCarne[2]["TAM-P"]; ?></td>
        <td><?php echo $LegumesCarne[2]["TAM-M"]; ?></td>
        <td><?php echo $LegumesCarne[2]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesCarne[3]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesCarne[3]["TAM-P"]; ?></td>
        <td><?php echo $LegumesCarne[3]["TAM-M"]; ?></td>
        <td><?php echo $LegumesCarne[3]["TAM-G"]; ?></td>
      </tr>
      <tr>
        <td><?php echo $LegumesCarne[4]["IGREDIENTE"]; ?></td>
        <td><?php echo $LegumesCarne[4]["TAM-P"]; ?></td>
        <td><?php echo $LegumesCarne[4]["TAM-M"]; ?></td>
        <td><?php echo $LegumesCarne[4]["TAM-G"]; ?></td>
      </tr>
